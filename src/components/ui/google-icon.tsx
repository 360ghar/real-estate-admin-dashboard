...
/** Google "G" mark, used on the "Sign in with Google" button. */
export function GoogleIcon({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="#EA4335"
        d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.43-3.43C17.95 1.18 15.24 0 12 0A12 12 0 0 0 1.27 6.62l4 3.09C6.22 6.86 8.87 4.75 12 4.75z"
      />
    </svg>
  )
}
